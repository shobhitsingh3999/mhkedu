...
const features = [
  {
    icon: (
      <svg
        className="w-8 h-8 stroke-[#0F4C5C]"
        viewBox="0 0 32 32"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
          d="M16 4L19.2 12.8L28 16L19.2 19.2L16 28L12.8 19.2L4 16L12.8 12.8L16 4Z"
          strokeWidth="1.5"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, conse ctetur adipiscing elit, sed do eiu smod tempor incididunt.",
  },
  {
    icon: (
      <svg
    ...
    title: "Take control and learn about your Career",
    description:
      "Lorem ipsum dolor sit amet, conse ctetur adipiscing elit, sed do eiu smod tempor incididunt.",
  },
];
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row gap-20">
          ...
          <div className="lg:w-[40%] flex flex-col">
            ...
            <Button className="w-fit h-12 px-8 bg-[#0F4C5C] hover:bg-[#0F4C5C]/90 text-white rounded-full text-base">
              Consult Now!!
            </Button>
          </div>
