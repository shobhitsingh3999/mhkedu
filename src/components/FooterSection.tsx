    ...
    <footer className="bg-[#0F4C5C] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="mb-6">
              ...
              MHK Consultants: Your trusted partner for seamless visa services, expert guidance and personalized support to achieve global aspirations.
              </p>
            </div>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+918368641218" className="ml-3 text-white/90 hover:text-[#F6B84C]">+91 1234567890</a>
              </li>
              <li className="flex items-center">
                <div className="flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-white" viewBox="0 0 16 16">
                ...
                <a href="mailto:abroaddreams4@gmail.com" className="ml-3 text-white/90 hover:text-[#F6B84C]">info@gmail.com</a>
              </li>
            </ul>
      ...
      <div className="bg-[#F6B84C] py-4">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-[#0F4C5C]">
          ...
          <div>Website Designed By : WebOptily.com</div>
        </div>
      </div>
